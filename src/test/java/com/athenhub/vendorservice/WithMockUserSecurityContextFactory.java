...
/**
 * {@link com.athenhub.vendorservice.MockUser} 애노테이션 기반으로 테스트 실행 시 SecurityContext를 생성하는 팩토리 클래스.
 *
 ...
 *
 * <p>주어진 {@link com.athenhub.vendorservice.MockUser} 애노테이션의 속성(uuid, username, name, slackId,
 * roles)을 기반으로 {@link AuthenticatedUser} 객체(UserDetails 구현체)를 생성하고, 이를 principal로 가지는 {@link
 ...
 *
 * @see com.athenhub.vendorservice.MockUser
...
public class WithMockUserSecurityContextFactory
    implements WithSecurityContextFactory<com.athenhub.vendorservice.MockUser> {

  /**
   * 주어진 {@link com.athenhub.vendorservice.MockUser} 정보를 바탕으로 SecurityContext를 생성한다.
   *
   * @param user 테스트용 사용자 정보가 포함된 애노테이션 인스턴스
   * @return 설정된 인증 정보(Authentication)가 포함된 SecurityContext
   */
  @Override
  public SecurityContext createSecurityContext(com.athenhub.vendorservice.MockUser user) {
